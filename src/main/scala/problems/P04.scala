...
object P04 {
  ...
  def main(args: Array[String]): Unit = {
    println(lengthBuiltin(List(1, 2, 3, 4))) //4
    println(lengthRecursive(List(1, 2, 3, 4))) //4
    println(lengthTailRecursive(List(1, 2, 3, 4))) //4
    println(lengthFunctional(List(1, 2, 3, 4))) //4
  }
}
